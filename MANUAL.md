...
2. Iterate over each line of a file in order, applying each *text rule*
  independently.
...
3. Parse a whole file for preprocessor constructs like `` `ifdef `` and
  ...
  description text.
4. Parse the source description into a syntax tree.
  The grammatical structure of a syntax tree is described in IEEE1800-2017
  Annex A using Backus-Naur Form.
5. Iterate over each node of the syntax tree in order, applying each *syntax
  rule* independently.
